...
-- Populate sample workspaces with enterprise_name
INSERT INTO workspaces (id, name, enterprise_name, enterprise_id, created_at) VALUES
  ...
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Client Portfolio A', 'Digital Health Agency', '33333333-3333-3333-3333-333333333333', now()),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Product Development', 'BioTech Innovations', '22222222-2222-2222-2222-222222222222', now());

-- Populate sample projects with proper UUIDs
INSERT INTO projects (id, project_name, client_name, brand, workspace_id, project_description, expected_delivery_date, created_at) VALUES
  ...
  ('c3333333-3333-3333-3333-333333333333', 'Digital Therapeutics Platform', 'BioTech Innovations', 'MindHealth', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'AI compliance platform for digital therapeutics', '2025-07-20', now() - interval '45 days');
...
INSERT INTO ai_tool_usage_logs (id, client_id, tool_name, vendor_name, compliance_status, risk_level, usage_type, data_processed, metadata, timestamp) VALUES
  (gen_random_uuid(), 'a1111111-1111-1111-1111-111111111111', 'GPT-4 Turbo', 'OpenAI', 'compliant', 'low', 'content_generation', 'clinical_protocols', '{"workspace_id": "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", "purpose": "protocol_drafting"}', now() - interval '2 hours'),
  (gen_random_uuid(), 'a1111111-1111-1111-1111-111111111111', 'Claude-3.5 Sonnet', 'Anthropic', 'compliant', 'low', 'document_review', 'regulatory_submissions', '{"workspace_id": "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", "purpose": "document_analysis"}', now() - interval '1 hour'),
  (gen_random_uuid(), 'b2222222-2222-2222-2222-222222222222', 'Midjourney', 'Midjourney Inc', 'partial', 'medium', 'image_generation', 'marketing_visuals', '{"workspace_id": "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb", "purpose": "visual_content"}', now() - interval '4 hours'),
  (gen_random_uuid(), 'c3333333-3333-3333-3333-333333333333', 'Custom Medical AI', 'Internal', 'compliant', 'high', 'data_analysis', 'patient_data', '{"workspace_id": "dddddddd-dddd-dddd-dddd-dddddddddddd", "purpose": "therapeutic_analysis"}', now() - interval '30 minutes'),
  (gen_random_uuid(), 'b2222222-2222-2222-2222-222222222222', 'Copy.ai', 'Copy.ai', 'non_compliant', 'high', 'content_generation', 'marketing_copy', '{"workspace_id": "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb", "purpose": "advertising_copy"}', now() - interval '6 hours');
