...
export function DataPrivacyStep({ onNext, onPrev }: StepProps) {
  return (
    <div className="p-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Configure data handling and privacy requirements.</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-800">
              This step will include data classification, retention policies, geographic restrictions, 
